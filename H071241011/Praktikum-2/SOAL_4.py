...
waktu = input("Apakah Mayoritas Penggunaan Di Luar Jam Sibuk (off-peak) Atau Di Jam Sibuk (peak) ? ").lower()
jenis = input("Apakah Anda Pengguna Personal Atau Bisnis ? ").lower()
